...
RESULT_PATH = '/Users/mingu/Desktop/'
        ...
        for urls in soup.select("._sp_each_url"):
            try :
                ...
                if urls["href"].startswith("https://news.naver.com"):
                    ...
                    f.write("{}\t{}\n".format(news_detail[1], news_detail[0])) # new style
...
def excel_make():
    ...
    data.columns = ['years', 'title']
    #print(data)
    xlsx_outputFileName = '%s-%s-%s result.xlsx' % (now.year, now.month, now.day)
...
def main():
    ...
    crawler(3,query,s_date,e_date) #검색된 네이버뉴스의 기사내용을 크롤링합니다.
#    excel_make() #엑셀로 만들기
main()
